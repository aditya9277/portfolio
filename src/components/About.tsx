        ...
        <div className="bg-white/5 backdrop-blur-lg rounded-2xl p-8 md:p-12 border border-white/10 shadow-2xl">
          ...
          <div className="prose prose-lg text-gray-300 max-w-none">
            <p className="text-lg md:text-xl leading-relaxed mb-6">
              I'm a <span className="text-blue-400 font-semibold">B.Tech CSE student at VIT Bhopal</span> with a deep passion for building scalable software, AI applications, and DevOps systems. My journey in technology is driven by a commitment to creating solutions that don't just work—they make a meaningful impact.
            </p>
            
            <p className="text-lg md:text-xl leading-relaxed mb-6">
              With hands-on experience from internships at <span className="text-purple-400 font-semibold">Ernst & Young</span> and <span className="text-cyan-400 font-semibold">Persistent Systems</span>, I've developed a strong foundation in full-stack development, cloud technologies, and modern DevOps practices.
            </p>
